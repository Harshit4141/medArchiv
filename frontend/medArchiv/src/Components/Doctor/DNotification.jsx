            ...
            <tr className={style.tr}>
             ...
             {notif.map((notification,index)=>{
                return <tr className={style.data} key={index}>
                 ...
                 <td><Link to={`/DoctorAppointmentDeatils/${notification.id}`}><button className={notification.status=="Completed"?style.completebtn:notification.status=="Pending"?style.pendingbtn:style.scheduledbtn} id={style.btn}>view</button> </Link></td>
             </tr>
             })}
